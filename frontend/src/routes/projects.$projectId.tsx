  ...
  const getMetricTypeCategoryTotals = (metricType: {
    ...
    const stages = metricSummaryFilter.stageId
      ? projectMetricTypeSummary.stages.filter(
          (s) => s.stageId === Number(metricSummaryFilter.stageId),
        )
                ...
                <div className="grid gap-6 lg:grid-cols-[1fr,2fr]">
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    ...
                    <div className="rounded-lg border border-gray-200 p-3">
                      ...
                      <p className="text-lg font-semibold text-gray-900">
                        {formatPercentValue(
                          projectMetrics.schedule.delayRate,
                          1,
                        )}
                      </p>
                      <p className="text-xs text-gray-400">
              ...
              <Card title={t("metrics.qualityMetrics")}>
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="rounded-lg border border-gray-200 p-3">
                    ...
                    <p className="text-xs text-gray-400">
                      {t("metrics.defectsPerTestCase")}
                    </p>
                  </div>
                  <div className="rounded-lg border border-gray-200 p-3">
                    <p className="text-xs text-gray-500">
                      {t("metrics.tasksDelayed")}
                    </p>
                    <p className="text-lg font-semibold text-gray-900">
                      {formatPercentValue(projectMetrics.schedule.delayRate, 1)}
                    </p>
                    <p className="text-xs text-gray-400">
                      {t("metrics.delayInManMonths")}
                    </p>
                  </div>
                </div>
              </Card>
                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                  <div className="rounded-lg border border-gray-200 p-3">
                    ...
                    <p className="text-lg font-semibold text-gray-900">
                      {projectTestInsights
                        ? formatPercentValue(
                            projectTestInsights.bugRate * 100,
                            1,
                          )
                  ...
                  <div className="rounded-lg border border-gray-200 p-3">
                    <p className="text-xs text-gray-500">
                      {t("metrics.testCasesPerMinute")}
                    </p>
                    <p className="text-lg font-semibold text-gray-900">
                      {projectTestInsights
                        ? formatMetricValue(
                            projectTestInsights.testCasesPerMinute,
                            2,
                          )
                        : t("common.notAvailable")}
                    </p>
                      ...
                      {projectTestInsights
                        ? t("metrics.actualMinutes", {
                            value: formatMetricValue(
                              projectTestInsights.actualMinutes,
                              0,
                            ),
                          })
                        : t("common.notAvailable")}
            ...
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-4">
              <Card>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  ...
                  {sfSummary.byType.Other
                    ? `, ${sfSummary.byType.Other} Other`
                    : ""}
                </p>
              </Card>
              <Card>
              ...
              <Card>
                <p className="text-sm text-gray-500">
                  {t("screenFunction.averageProgress")}
                </p>
                <p className="mt-1 text-2xl font-semibold text-gray-900">
                        ...
                        <div className="flex items-center gap-2">
                          {selectedStage.stageColor && (
                            <span
                              ...
                              style={{
                                backgroundColor: selectedStage.stageColor,
                              }}
                            />
                          )}
            ...
            <div className="mb-4 flex flex-wrap gap-4">
              <div className="flex-1 min-w-[200px]">
                <Input
                  ...
                  onChange={(e) =>
                    setSfFilter({ ...sfFilter, search: e.target.value })
                  }
                />
              </div>
              <Select
                value={sfFilter.type}
                onChange={(e) =>
                  setSfFilter({ ...sfFilter, type: e.target.value })
                }
                options={[
                  ...
                  {
                    value: "Function",
                    label: t("screenFunction.typeFunction"),
                  },
                  {
                    value: "Other",
                    label: t("screenFunction.typeOther", {
                      defaultValue: "Other",
                    }),
                  },
                ]}
              ...
              <Select
                ...
                onChange={(e) =>
                  setSfFilter({ ...sfFilter, status: e.target.value })
                }
                options={[
                  { value: "", label: t("screenFunction.allStatuses") },
                  {
                    value: "Not Started",
                    label: t("screenFunction.statusNotStarted"),
                  },
                  {
                    value: "In Progress",
                    label: t("screenFunction.statusInProgress"),
                  },
                  {
                    value: "Completed",
                    label: t("screenFunction.statusCompleted"),
                  },
                ]}
                fullWidth={false}
              />
            ...
            {filteredScreenFunctions && filteredScreenFunctions.length > 0 ? (
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-300">
                  <thead>
                    <tr>
                      <th className="py-3.5 pl-4 pr-1 text-center text-sm font-semibold text-gray-900 w-10">
                        #
                      </th>
                      ...
                      <th className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">
                        {t("screenFunction.priority")}
                      </th>
                      <th className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">
                        {t("screenFunction.complexity")}
                      </th>
                      <th className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">
                        {t("common.status")}
                      </th>
                      ...
                      <th className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">
                        {t("screenFunction.defaultAssignees", {
                        ...
                        <td className="whitespace-nowrap px-3 py-4 text-sm">
                          <div className="flex gap-2">
                            ...
                            <Button
                              ...
                              onClick={() => {
                                if (
                                  confirm(t("screenFunction.confirmDelete"))
                                ) {
          ...
          <Card
            ...
            actions={
              <div className="flex gap-2">
                <Button
                  variant="secondary"
                  onClick={() => setShowCopyMembers(true)}
                >
            ...
            <div className="mb-4 flex flex-wrap gap-4">
              <div className="flex-1 min-w-[200px]">
                <Input
                  ...
                  onChange={(e) =>
                    setMemberFilter({ ...memberFilter, search: e.target.value })
                  }
                />
              </div>
              <Select
                ...
                onChange={(e) =>
                  setMemberFilter({ ...memberFilter, role: e.target.value })
                }
                options={[
              ...
              <Select
                ...
                onChange={(e) =>
                  setMemberFilter({ ...memberFilter, status: e.target.value })
                }
                options={[
                              ...
                              {workload && workload.totalAssigned > 0 ? (
                                <div className="text-xs">
                                  <p className="font-medium">
                                    ...
                                    {t("member.totalAssigned")}
                                  </p>
                                  <p className="text-gray-500">
                                    {workload.completedTasks} {t("member.done")}{" "}
                                    / {workload.inProgressTasks}{" "}
                                    {t("member.active")}
                                  </p>
                                  {(workload.totalEstimatedEffort > 0 ||
                                    workload.totalActualEffort > 0) && (
                                    <p className="text-gray-400 mt-0.5">
                                      {displayEffort(
                                        workload.totalEstimatedEffort,
                                        "man-hour",
                                      )}{" "}
                                      /{" "}
                                      {displayEffort(
                                        workload.totalActualEffort,
                                        "man-hour",
                                      )}{" "}
                                      {EFFORT_UNIT_LABELS[effortUnit]}
                                    </p>
                ...
                {metricReportView === "details" && (
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-[2fr,1fr]">
                      <Input
                        placeholder={t(
                          "metrics.metricSummarySearchPlaceholder",
                        )}
                    ...
                    {projectMetricTypeSummary.metricTypes.map(
                      (metricType, index) => {
                        const filteredStages =
                          getFilteredMetricStages(metricType);
                        const metricVisual = getMetricTypeVisual(
                          metricType.name,
                        );
                        const { categoryTotals, grandTotal } =
                          getMetricTypeCategoryTotals(metricType);
                        const nonZeroCategories = categoryTotals.filter(
                          (cat) => cat.total > 0,
                        );
                        return (
                          <details
                            ...
                            <summary className="flex cursor-pointer flex-wrap items-start justify-between gap-4">
                              ...
                              <div className="flex flex-col gap-1 min-w-[200px]">
                                {nonZeroCategories.map((category) => {
                                  const originalIndex =
                                    metricType.categories.findIndex(
                                      (c) => c.id === category.id,
                                    );
                                  return (
                                    <div
                            ...
                            <div className="mt-4 space-y-4">
                              {filteredStages.length === 0 ? (
                                <EmptyState
                                  ...
                                  description={t(
                                    "metrics.metricSummaryTryAnother",
                                  )}
                                />
                              ) : (
                                    ...
                                    <div className="flex flex-wrap items-center justify-between gap-2">
                                      ...
                                      <div className="text-xs text-gray-500">
                                        {t("metrics.screenFunctionCount", {
                                          value:
                                            getStageScreenFunctionCount(stage),
                                        })}
                                      </div>
                                    </div>
                                        ...
                                        >
                                          ...
                                          <div className="relative">
                                            ...
                                            <div className="flex items-center justify-between rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-800">
                                              ...
                                              <span className="text-xs text-gray-500">
                                                {t(
                                                  "metrics.stepScreenFunctionCount",
                                                  {
                                                    value:
                                                      step.screenFunctions
                                                        .length,
                                                  },
                                                )}
                                              </span>
                                          ...
                                          <div className="mt-3 space-y-3 pl-4">
                                            {step.screenFunctions.map(
                                              (screenFunction) => (
                                                <div
                                                  key={
                                                    screenFunction.stepScreenFunctionId
                                                  }
                                                  className="relative pl-6"
                                                >
          ...
          <Card title={t("settings.workTimeConfig")}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                ...
                />
                <p className="text-xs text-gray-500 mt-1">
                  {t("settings.standard")}: 20-22 {t("time.days")}/
                  {t("time.months")}
                </p>
              </div>
              <div>
            ...
            <div className="mt-6 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="grid grid-cols-3 gap-4 text-sm">
                ...
                <div className="text-center p-3 bg-white rounded border">
                  <p className="text-2xl font-bold text-primary">
                    {settingsForm.workingHoursPerDay *
                      settingsForm.workingDaysPerMonth}
                  </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>
                    1 MH = {(1 / settingsForm.workingHoursPerDay).toFixed(4)} MD
                  </li>
                  <li>
                    1 MH ={" "}
                    {(
              ...
              <div>
                ...
                <ul className="text-sm text-gray-600 space-y-1">
                  ...
                  <li>
                    1 MD = {(1 / settingsForm.workingDaysPerMonth).toFixed(4)}{" "}
                    MM
                  </li>
                </ul>
              </div>
            ...
            <div className="mb-6">
              ...
              <div className="flex flex-wrap gap-2">
                {DAYS_OF_WEEK.map((day) => {
                  const isSelected = settingsForm.nonWorkingDays.includes(
                    day.value,
                  );
                      ...
                      onClick={() => {
                        ...
                        setSettingsForm({
                          ...
                          nonWorkingDays: isSelected
                            ? settingsForm.nonWorkingDays.filter(
                                (d) => d !== day.value,
                              )
                            : [...settingsForm.nonWorkingDays, day.value].sort(
                                (a, b) => a - b,
                              ),
                        });
                      }}
              ...
              <div className="flex gap-2 mb-3">
                ...
                <Button
                  ...
                  onClick={() => {
                    if (
                      newHoliday &&
                      !settingsForm.holidays.includes(newHoliday)
                    ) {
                      setSettingsForm({
                        ...settingsForm,
                    ...
                    >
                      ...
                      <button
                        ...
                        onClick={() => {
                          setSettingsForm({
                            ...settingsForm,
                            holidays: settingsForm.holidays.filter(
                              (h) => h !== holiday,
                            ),
                          });
                        }}
